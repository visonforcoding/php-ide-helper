...
class Redis  {
     ...
     * @param float $timeout
     * @param type $reserved
     * @param type $retry_interval value in milliseconds 
     * @return BOOL: TRUE on success, FALSE on error.
     */
	public function connect($host='127.0.0.1',$port=6379,$timeout=0,$reserved=null,$retry_interval=0) {}
     ...
     * @param callback $f  either a string or an array($instance, 'method_name'). 
     ...
     */
	public function subscribe($channels,$f) {}
